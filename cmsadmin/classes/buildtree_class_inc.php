...
class buildtree extends ChisimbaObject {
     ...
     * @access public
     */
    public function show($currentId = null, $parentId = '0', 
            $treeType = 'tree', $linkClass = null, 
            $headerClass = null, $recursionDepth = 999999, 
            $specifiedLink = null, $onlyPublished = TRUE, 
            $noPermissions = TRUE) {
        $html = '';
        if ($treeType == 'cooljs') {
     ...
     * @access public
     */
    public function buildStaticMenu($parentId = '0', $linkClass = null, 
            $headerClass = null, $onlyPublished = FALSE) {
        $html = '';
        if (!is_null($linkClass)) {
