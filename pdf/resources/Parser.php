...
require_once 'modules/pdf/resources/Element/Array.php';

/** Zend_Pdf_Element_String_Binary */
require_once 'modules/pdf/resources/Element/String/Binary.php';

/** Zend_Pdf_Element_Boolean */
require_once 'modules/pdf/resources/Element/Boolean.php';

/** Zend_Pdf_Element_Dictionary */
require_once 'modules/pdf/resources/Element/Dictionary.php';

/** Zend_Pdf_Element_Name */
require_once 'modules/pdf/resources/Element/Name.php';

/** Zend_Pdf_Element_Numeric */
require_once 'modules/pdf/resources/Element/Numeric.php';

/** Zend_Pdf_Element_Object */
require_once 'modules/pdf/resources/Element/Object.php';

/** Zend_Pdf_Element_Reference */
require_once 'modules/pdf/resources/Element/Reference.php';

/** Zend_Pdf_Element_Stream */
require_once 'modules/pdf/resources/Element/Stream.php';

/** Zend_Pdf_Element_Object_Stream */
require_once 'modules/pdf/resources/Element/Object/Stream.php';

/** Zend_Pdf_Element_String */
require_once 'modules/pdf/resources/Element/String.php';

/** Zend_Pdf_Element_Null */
require_once 'modules/pdf/resources/Element/Null.php';

/** Zend_Pdf_Element_Reference_Context */
require_once 'modules/pdf/resources/Element/Reference/Context.php';

/** Zend_Pdf_Element_Reference_Table */
require_once 'modules/pdf/resources/Element/Reference/Table.php';

/** Zend_Pdf_Trailer_Keeper */
require_once 'modules/pdf/resources/Trailer/Keeper.php';

/** Zend_Pdf_ElementFactory */
require_once 'modules/pdf/resources/ElementFactory.php';

/** Zend_Pdf_PHPArray */
require_once 'modules/pdf/resources/PHPArray.php';

/** Zend_Pdf_StringParser */
require_once 'modules/pdf/resources/StringParser.php';

/** Zend_Pdf_Parser_Stream */
require_once 'modules/pdf/resources/Parser/Stream.php';
