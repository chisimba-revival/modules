...
require_once 'Trailer/Keeper.php';

/** Zend_Pdf_Trailer_Generator */
require_once 'Trailer/Generator.php';

/** Zend_Pdf_Color */
require_once 'Color.php';

/** Zend_Pdf_Color_GrayScale */
require_once 'Color/GrayScale.php';

/** Zend_Pdf_Color_RGB */
require_once 'Color/RGB.php';

/** Zend_Pdf_Color_CMYK */
require_once 'Color/CMYK.php';

/** Zend_Pdf_Color_HTML */
require_once 'Color/HTML.php';

/** Zend_Pdf_Image */
require_once 'Resource/Image.php';

/** Zend_Pdf_Image */
require_once 'Resource/ImageFactory.php';

/** Zend_Pdf_Image_JPEG */
require_once 'Resource/Image/JPEG.php';

/** Zend_Pdf_Image_TIFF */
require_once 'Resource/Image/TIFF.php';

/** Zend_Pdf_Image_PNG */
require_once 'Resource/Image/PNG.php';
