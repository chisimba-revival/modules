 ...
 * Gallery
 * 
 * A photo, audio and video gallery that requires a customised version of Gallery3. If you do not have Gallery3 and do not know what it is, do not install this module as it will not do anything.
 * 
 * PHP version 5
 * 
...
class gallery extends controller
{
    ...
    */
    ...
    public function dispatch()
    {
        ...
        $uri = $objSysConfig->getValue('MOD_GALLERY_URI', 'gallery');
        $loc = 'Location: ' . $uri;
        header($loc);
    }
