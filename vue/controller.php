...
/**
* 
* Controller class for Chisimba for the module vue
*
* @author Derek Keats
* @package vue
*
...
class vue extends controller
{
    ...
    */
    ...
    /**
    * 
    * Intialiser for the vue controller
    * @access public
    * 
    */
    ...
    /**
     * 
     * The standard dispatch method for the vue module.
