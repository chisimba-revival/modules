...
<div class="chisimba-form-field chisimba-form-field--full"><label for="registration-username"><?php echo $e($t('username')); ?></label><input id="registration-username" name="username" type="text" maxlength="255" pattern="[A-Za-z0-9][A-Za-z0-9._-]*" autocomplete="username" aria-describedby="registration-username-help" value="<?php echo $e($v['username'] ?? ''); ?>" required><small id="registration-username-help" class="chisimba-field-help"><?php echo $e($t('username_help')); ?></small></div>
