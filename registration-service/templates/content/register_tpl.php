...
<div><label for="registration-password"><?php echo $e($t('password')); ?></label><input id="registration-password" name="password" type="password" autocomplete="new-password" required></div>
<div><label for="registration-password-confirm"><?php echo $e($t('password_confirm')); ?></label><input id="registration-password-confirm" name="password_confirm" type="password" autocomplete="new-password" required></div>
