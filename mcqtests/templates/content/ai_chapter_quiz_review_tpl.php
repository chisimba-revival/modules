...
<h1><?php echo $e($this->objLanguage->languageText('mod_mcqtests_ai_chapter_review', 'mcqtests')); ?></h1>
<p><?php echo $e($this->objLanguage->languageText('mod_mcqtests_ai_chapter_review_help', 'mcqtests')); ?></p>
...
<?php endforeach; ?>
<form method="post" action="<?php echo $e($u(array('action' => 'aiinsertchapterquizzes'))); ?>"><input type="hidden" name="csrf_token" value="<?php echo $e($chapterQuizToken); ?>" /><div class="chisimba-form-actions"><button class="button" type="submit"><?php echo $e($this->objLanguage->languageText('mod_mcqtests_ai_chapter_create', 'mcqtests')); ?></button><a class="button chisimba-button-secondary" href="<?php echo $e($u(array('action' => 'aichapterquizzes'))); ?>"><?php echo $e($this->objLanguage->languageText('word_cancel', 'system')); ?></a></div></form>
</section>
