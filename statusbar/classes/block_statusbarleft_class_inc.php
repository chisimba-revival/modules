...
/**
 *
 * A left block for statusbar.
 *
 * A left block for statusbar. This creates a floating bar to hold various icon links to features that should be available to the user at all times regardless of the page the user is viewing..
 *
 ...
 *
 */
class block_statusbarleft extends ChisimbaObject
{
    /**
