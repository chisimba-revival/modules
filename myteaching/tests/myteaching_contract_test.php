...
$checks=array(
 ...
 'course entry separates teaching and management'=>str_contains($overview,"'contextaction'=>'controlpanel'")&&str_contains($overview,"'Manage [-context-]'")&&str_contains($overview,"'Enter [-context-]'")&&str_contains($overview,"'action'=>'leavecontext'")&&str_contains($overview,'Leave [-context-]'),
