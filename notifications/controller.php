...
class notifications extends controller
{
 ...
 private function markRead(){if($this->method()!=='POST')return $this->json(array('ok'=>false,'error'=>array('code'=>'method_not_allowed')),405);if(!$this->csrf->consume(self::CSRF,(string)$this->getParam('csrf_token','')))return $this->json(array('ok'=>false,'error'=>array('code'=>'invalid_csrf')),403);$ok=$this->service->markRead(trim((string)$this->getParam('notification_id','')),$this->user->userId());return $this->json(array('ok'=>$ok,'code'=>$ok?'marked_read':'invalid_notification'),$ok?200:400);}
