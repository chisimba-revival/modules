...
*
*/
class uwcskinhelper extends controller
{
    ...
    */
    public function init()
    {
        ...
        $this->objDbuwcskinhelper = & $this->getObject('dbuwcskinhelper', 'uwcskinhelper');
    ...
    /**
     * 
     * The standard dispatch method for the uwcskinhelper module.
    ...
    */
    ...
    {
        $mode = $this->getParam("mode", NULL);
        $this->objDbuwcskinhelper->save($mode);
