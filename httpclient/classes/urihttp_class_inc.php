...
class urihttp extends aburi
{
    ...
    protected function __construct($scheme, $schemeSpecific = '')
    {
         ...
         */
        if (!$this->valid()) {
            throw new customException('Invalid URI supplied');
        }
    ...
    protected function _parseUri($schemeSpecific)
    {
        ...
        if ($status === false) {
            throw new customException('Internal error: scheme-specific decomposition failed');
        }
        ...
        if ($status === false) {
            throw new customException('Internal error: authority decomposition failed');
        }
    ...
    {
        if (!$this->valid()) {
            throw new customException('One or more parts of the URI are invalid');
        }
    ...
    public function validateUsername($username = null)
    {
        ...
        if ($status === false) {
            throw new customException('Internal error: username validation failed');
        }
        return $status == 1;
    }
    ...
    public function setUsername($username)
    {
        if (!$this->validateUsername($username)) {
            throw new customException("Username \"$username\" is not a valid HTTP username");
        }
    ...
    public function validatePassword($password = null)
    {
        ...
        if ($status === false) {
            throw new customException('Internal error: password validation failed.');
        }
        return $status == 1;
    }
    ...
    public function setPassword($password)
    {
        if (!$this->validatePassword($password)) {
            throw new customException("Password \"$password\" is not a valid HTTP password.");
        }
    ...
    public function validateHost($host = null)
    {
        ...
        /**
         * Check the host against the allowed values; delegated to Filter.
         */
        return filter::isHostname($host) !== FALSE;
    }
    ...
    public function setHost($host)
    {
        if (!$this->validateHost($host)) {
            throw new customException("Host \"$host\" is not a valid HTTP host");
        }
        $oldHost = $this->_host;
        $this->_host = $host;
        return $oldHost;
    ...
    public function setPort($port)
    {
        if (!$this->validatePort($port)) {
            throw new customException("Port \"$port\" is not a valid HTTP port.");
        }
        $oldPort = $this->_port;
        $this->_port = $port;
        return $oldPort;
    ...
    public function validatePath($path = null)
    {
        ...
        if ($status === false) {
            throw new customException('Internal error: path validation failed');
        }
    ...
    public function setPath($path)
    {
        if (!$this->validatePath($path)) {
            throw new customException("Path \"$path\" is not a valid HTTP path");
        }
        $oldPath = $this->_path;
        $this->_path = $path;
        return $oldPath;
    ...
    public function validateQuery($query = null)
    {
        ...
        if ($status === false) {
            throw new customException('Internal error: query validation failed');
        }
        return true;
    }
    ...
    public function setQueryArray($array = array())
    {
        ...
        if (!is_array($array)) {
            throw new customException('Query array is neither a scalar nor an array');
        }
    ...
    private function _queryArrayRecurse($array = array(), $key = null, &$queryVars = array())
    {
        ...
        if (is_scalar($array)) {
            ...
            throw new customException('Query array content is neither a scalar nor an array');
        }
        if (!is_null($key)) {
            array_pop($queryVarNames);
        }
    ...
    public function setQueryString($query)
    {
        if (!$this->validateQuery($query)) {
            throw new customException("Query string \"$query\" is not a valid HTTP query string");
        }
    ...
    public function validateFragment($fragment = null)
    {
        ...
        if ($status === false) {
            throw new customException('Internal error: fragment validation failed');
        }
        return true;
    }
    ...
    public function setFragment($fragment)
    {
        if (!$this->validateFragment($fragment)) {
            throw new customException("Fragment \"$fragment\" is not a valid HTTP fragment");
        }
