...
class block_blogarchive extends ChisimbaObject
{
    public $title;
    ...
    public function show() { return $this->getObject('publishingsidebar','simpleblog')->render('archive',$this->type,$this->scope,$this->exclude); }
}
