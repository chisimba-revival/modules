...
/**
 *
 * An about block for the site blog
 *
 * Displays the title and description information for the site blog.
 *
 ...
 *
 */
class block_aboutsiteblog extends ChisimbaObject
{
    /**
     *
    ...
    public function init() 
    {
        ...
        if (!$title == "") {
            ...
            $this->title = $this->objLanguage->languageText(
                "mod_simpleblog_site", "simpleblog",
                "Site blog");
        }
