...
$required=array('controller.php','register.conf','classes/knowledgemapgraphservice_class_inc.php','classes/knowledgemapimportservice_class_inc.php','classes/knowledgemapproviderregistry_class_inc.php','classes/knowledgemapauthorizationservice_class_inc.php','classes/knowmapembedservice_class_inc.php','sql/tbl_knowledgemap_maps.sql','sql/tbl_knowledgemap_nodes.sql','sql/tbl_knowledgemap_relationships.sql','sql/tbl_knowledgemap_access.sql','templates/content/index_tpl.php','templates/content/view_tpl.php','resources/knowledgemap.css','resources/knowledgemap.js');
...
$checks=array(
    ...
    'workspace chrome can collapse without hiding exit'=>str_contains($template,'data-knowmap-action="chrome"')&&str_contains($template,'Exit to Chisimba')&&str_contains($read('resources/knowledgemap.js'),'prototype.toggleChrome')&&str_contains($css,'.knowmap-view.is-chrome-collapsed'),
    'map workspace fills available height'=>str_contains($css,'height: calc(100vh - 1rem)')&&str_contains($css,'.knowmap-view.is-panel-closed'),
