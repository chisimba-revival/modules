...
class dbwebpresentdownloadcounter extends dbtable
{
    ...
    */
    ...
    {
        $sql = 'SELECT count(tbl_webpresent_downloads.id) as viewcount, tbl_webpresent_files.* FROM tbl_webpresent_downloads, tbl_webpresent_files WHERE (tbl_webpresent_files.id = tbl_webpresent_downloads.fileid AND datedownloaded=\''.date('Y-m-d').'\' ) GROUP BY tbl_webpresent_downloads.fileid Order by viewcount desc limit 5';
    ...
    public function getMostDownloadedThisWeek()
    {
        ...
        // SQL
        $sql = 'SELECT count(tbl_webpresent_downloads.id) as viewcount, tbl_webpresent_files.* FROM tbl_webpresent_downloads, tbl_webpresent_files WHERE (tbl_webpresent_files.id = tbl_webpresent_downloads.fileid AND datedownloaded > \''.$startOfWeek .'\' ) GROUP BY tbl_webpresent_downloads.fileid Order by viewcount desc limit 5';
    ...
    {
        $sql = 'SELECT count(tbl_webpresent_downloads.id) as viewcount, tbl_webpresent_files.* FROM tbl_webpresent_downloads, tbl_webpresent_files WHERE (tbl_webpresent_files.id = tbl_webpresent_downloads.fileid ) GROUP BY tbl_webpresent_downloads.fileid Order by viewcount DESC LIMIT 5';
        return $this->getArray($sql);
    }
