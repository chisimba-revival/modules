...
class oembed extends controller
{
    ...
    */
    ...
    /**
    *
    * Method corresponding to the demo action. It fetches the default
    * embeded item or one specified by embed=http://url in the
    * querystring.
    *
    * @access private
    ...
    */
    private function __demo()
    {
        ...
        $strUrl = $this->getParam('embed', 'http://vimeo.com/3108686');
        $str .= '<div><a href="' . $strUrl . '" class="oembed">Loading...</a></div>';
