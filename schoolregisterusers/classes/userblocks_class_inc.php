...
/**
 *
 * User blocks functionality for schoolregisterusers module
 *
 * User blocks functionality for schoolregisterusers module provides 
...
/**
    ...
    function setupLanguageItems() {
        ...
        $arrayVars['confirm_delete_user'] = "mod_schoolregisterusers_confirm_delete_user";
    ...
    public function showEditMyDetails()
    {
        ...
        if ($this->objUser->isLoggedIn()) {
            ...
            $linkText = $this->objLanguage->languageText(
              'mod_schoolregisterusers_selfreg', 'schoolregisterusers');
          ...
          $objGroupOps->isGroupMember($groupId, $userId )) {
            ...
            $ret = $table->show();
                $h = $this->objLanguage->languageText(
                      'mod_schoolregisterusers_ulst', 'schoolregisterusers');
                if ($firstRender == TRUE) {
                    $ret = "<h1>$h</h1><br />"
            ...
            $ret = $this->objLanguage->languageText(
              'mod_schoolregisterusers_nvrts', 'schoolregisterusers');
          }
          return $ret;
    }
