...
/**
 *
 * User editor functionality for schoolregisterusers module
 *
 * User editor functionality for schoolregisterusers module 
 * provides for the creation of the user edit form, which 
 * is used by the class block_useredit_class_inc.php
 *
 * PHP version 5
 *
