 ...
 *
 */
class block_speciesmiddle extends ChisimbaObject
{
    /**
    ...
    public function init() 
    {
        ...
        $this->title = $this->objLanguage->languageText(
                "mod_species_middletitle", "species",
                "Species mashup");
    }
    /**
    ...
    public function show() 
    {
        ...
        switch ($action) {
            ...
            case "byletter":
                ...
                $field = $this->getParam('field', 'alphabeticalname');
                return $objOps->listSpeciesByLetter($letter, $field);
                break;
            case "showsp":
