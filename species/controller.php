 ...
 * Species
 * 
 * Manage a database of information about species within a group, for example birds. Store common name, Latin name, a link to one or more free content images from Flickr, as well as imported text from Wikipedia where it exists.
 * 
 * PHP version 5
 * 
...
/**
* 
* Controller class for Chisimba for the module species
*
* @author Derek Keats
* @package species
*
...
class species extends controller
{
    ...
    */
    ...
    /**
    * 
    * Intialiser for the species controller
    * @access public
    * 
    */
    ...
    */
    ...
    /**
    * 
    * Method corresponding to the byletter action for viewing an alphabetical 
    * list of species
    * 
    * @access private
    * 
    */
    private function __byletter()
    {
        // All the action is in the blocks
        return "main_tpl.php";
    }
    ...
    /**
    * 
    * Method corresponding to the showsp action for viewing a the detals of 
    * list of a species identified by the id from the querystring.
    * 
    * @access private
    * 
    */
    private function __showsp()
    {
        // All the action is in the blocks
        return "main_tpl.php";
    }
