...
/**
*
* Controller class for Chisimba for the module disqus
*
* @author Derek Keats
* @package disqus
*
*/
class disqus extends controller
{
    ...
    */
    ...
    /**
    *
    * Intialiser for the disqus controller
    * @access public
    *
    */
    ...
    /**
     *
     * The standard dispatch method for the disqus module.
