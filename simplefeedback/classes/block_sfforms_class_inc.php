...
/**
 * 
  * A forms block for Simple feedback.
 *
 * A forms block for Simple feedback. Provide a means to obtain basic 
 * simple feedback from something that has happened on relevant to the site. 
 * This block lists the forms for going to feedback, editing them, or viewing
 * the results.
 *
 * @category  Chisimba
 * @author    Derek Keats derekkeats@gmail.com
 ...
 *
 */
class block_sfforms extends ChisimbaObject
{
    /**
