...
class section_page extends ChisimbaObject
{
    ...
    */
    public function renderSection($category)
    {
        ...
        if ($firstStory == FALSE) {
            ...
            '<div class="noRecordsMessage">'.$this->objLanguage->languageText('mod_hotels_categorydoesnothavestories', 'hotels', 'This category does not have any hotels yet.').'</div>';
        } else {
