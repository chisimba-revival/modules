...
if($this->getObject('webinareditpolicy','webinar')->canManage())echo '<nav class="chisimba-form-actions">'.$r->button('add','plus',['action'=>'edit']).$r->button('manage','list',['action'=>'manage']).'</nav>';
