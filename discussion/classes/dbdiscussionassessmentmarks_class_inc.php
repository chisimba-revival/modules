...
class dbdiscussionassessmentmarks extends dbtable
{
    ...
    public function saveMark($discussionId,$userId,$mark,$feedback,$markerId,$rubricJson,$aiJobId=null,$evidenceFingerprint=null)
    {
        ...
        $data['evidence_fingerprint']=$evidenceFingerprint;
