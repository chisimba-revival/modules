...
$attachmentForm = new form('attachmentForm', $this->uri( array('action'=>'addattachment', 'type'=>$discussiontype)));
...
// Discussion
$hiddenId = new textinput('discussion');
$hiddenId->fldType = 'hidden';
$hiddenId->value = $discussion;
$attachmentForm->addToForm($hiddenId->show());

$submitButton = new button('submitform', $this->objLanguage->languageText('mod_discussion_attachselected'));
...
$table->startRow();
$fileLabel = new label($this->objLanguage->languageText('mod_discussion_filetoupload'), 'input_userFile');
...
$submitButton = new button('submitform2', $this->objLanguage->languageText('mod_discussion_uploadfile'));
$submitButton->cssClass = 'upload';
$submitButton->setToSubmit();
