...
//
//
//echo '<h1>'.$this->objLanguage->languageText('mod_discussion_moderatetopic', 'discussion', 'Moderate Topic').': '.$topic['post_title'].'</h1>';
//
...
//}
//
//echo '<p>'.$this->objLanguage->languageText('mod_discussion_whattodowithtopic', 'discussion', 'What would you like to do with this topic?').'</p>';
//
//
...
//    }
//
//    $deleteForm->addToForm($this->objLanguage->languageText('mod_discussion_confirmdeletetopic', 'discussion', 'Are you sure you want to delete this topic?').'</strong> ');
//
...
//
//echo '<p align="center">'.$returnLink->show().' / '.$returnDiscussionLink->show().'</p>';
