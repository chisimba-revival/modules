 ...
 * A sitewall block
 *
 * A sitewall block for rendering the site's wall. For example, allows a wall
 * to be rendered at the level of the pre / post login
 *
 ...
 *
 */
class block_sitewall extends ChisimbaObject
{
    /**
