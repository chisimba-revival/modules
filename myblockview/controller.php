...
/**
* 
* Controller class for Chisimba for the module myblockview
*
* @author Derek Keats
* @package myblockview
*
*/
class myblockview extends controller
{
    ...
    */
    ...
    /**
    * 
    * Intialiser for the myblockview controller
    * @access public
    * 
    */
    ...
    /**
     * 
     * The standard dispatch method for the myblockview module.
