...
/**
 * Simplegallery MetaWebLog interface class
 * 
 ...
 * @version   $Id: metaweblogapi_class_inc.php 11040 2008-10-24 15:45:36Z charlvn $
...
/**
 * Simplegallery MetaWebLog XML-RPC Class
 * 
 ...
 * @see       core
 */
class simplegalmetaweblogapi extends ChisimbaObject
{
    ...
    public function init()
    {
        try {
            ...
            $this->isReg = $this->objModules->checkIfRegistered('simplegal');
            if($this->isReg === TRUE)
            {
    ...
    public function metaWeblogNewPost($params)
    {
        ...
        //log_debug($postarray);
        $ret = $this->objDbGal->insertPostAPI($userid, $postarray);
    ...
    public function metaWeblogGetCategories($params)
    {
        ...
        $userid = $this->objUser->getUserId($username);
        $resarr = $this->objDbGal->getParentCats($userid);
    ...
    public function metaWeblogGetRecentPosts($params)
    {
        ...
        $userid = $this->objUser->getUserId($username);
        $resarr = $this->objDbGal->getLastPosts($numposts, $userid);
    ...
    public function metaWeblogGetPost($params)
    {
        ...
        //go get the post
        $post = $this->objDbGal->getPostById($postid);
        $post = $post[0];
        //log_debug($post);
