...
*/
class dbpodcasterschedules extends dbtable
{
    ...
    */
    ...
    public function getSchedules()
    {
         $sql="select fl.title,fl.filename,fl.creatorid,fl.id,sch.fileid,sch.schedule_date,sch.status".
              " from tbl_podcaster_files fl,tbl_podcaster_schedules sch".
   ...
   //     $sql = "UPDATE tbl_podcaster_schedules set schedule_date = ".$date." and status = '".$status."' where id = '".$id."'";
