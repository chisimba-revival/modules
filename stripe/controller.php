 ...
 * Stripe
 * 
 * Provides for a stripe or bar that can be installed at the top of the page or bottom of the page to integrate messaging and related functionality.
 * 
 * PHP version 5
 * 
...
/**
* 
* Controller class for Chisimba for the module stripe
*
* @author Derek Keats
* @package stripe
*
...
class stripe extends controller
{
    ...
    */
    ...
    /**
    * 
    * Intialiser for the stripe controller
    * @access public
    * 
    */
    public function init()
    {
        ...
        $this->objDbstripe = & $this->getObject('dbstripe', 'stripe');
        $this->appendArrayVar('headerParams',
          $this->getJavaScriptFile('stripe.js',
          'stripe'));
    ...
    /**
     * 
     * The standard dispatch method for the stripe module.
