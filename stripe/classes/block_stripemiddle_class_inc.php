...
/**
 *
 * A middle block for Stripe.
 *
 * A middle block for Stripe. Provides for a stripe or bar that can be installed at the top of the page or bottom of the page to integrate messaging and related functionality..
 *
 ...
 *
 */
class block_stripemiddle extends ChisimbaObject
{
    /**
