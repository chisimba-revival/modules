...
class dbhotelslocations extends dbtable
{

    public function init()
    {
        parent::init('tbl_hotels_locations');
    ...
    */
    ...
    {
        $sqlLeft = 'UPDATE tbl_hotels_locations SET rght=rght+'.$amount.' WHERE rght > '.$base;
        $sqlRight = 'UPDATE tbl_hotels_locations SET lft=lft+'.$amount.' WHERE lft > '.$base;
