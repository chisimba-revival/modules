...
class hotels extends controller
{
    ...
    */
    ...
    {
        $this->objNewsCategories = $this->getObject('dbhotelscategories');
        $this->objNewsMenu = $this->getObject('dbhotelsmenu');
        $this->objNewsStories = $this->getObject('dbhotelsstories');
        $this->objKeywords = $this->getObject('dbhotelskeywords');
        $this->objTags = $this->getObject('dbhotelstags');
        $this->objComments = $this->getObject('dbhotelscomments');
        
        $this->objLanguage = $this->getObject('language', 'language');
        
        $this->objNewsBlocks = $this->getObject('dbhotelsblocks');
