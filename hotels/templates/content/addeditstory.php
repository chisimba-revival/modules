...
if ($mode == 'edit') {
    ...
    $title = $this->objLanguage->languageText('mod_hotels_editstory', 'hotels', 'Edit Hotel').': '.$story['storytitle'];
    $buttonText = $this->objLanguage->languageText('mod_hotels_updatestory', 'hotels', 'Update Hotel');
} else {
    $formAction = 'savestory';
    $title = $this->objLanguage->languageText('mod_hotels_addnewstory', 'hotels', 'Add Hotel');
    $buttonText = $this->objLanguage->languageText('mod_hotels_savestory', 'hotels', 'Save Story');
}
...
$label = new label ($this->objLanguage->languageText('mod_hotels_storytitle', 'hotels', 'Hotel Title'), 'input_storytitle');
...
$formTable->startRow();
$formTable->addCell($this->objLanguage->languageText('mod_hotels_storydate', 'hotels', 'Story Date'));
...
$formTable->startRow();
$formTable->addCell($this->objLanguage->languageText('mod_hotels_publishdate', 'hotels', 'Publish Date').'<br /><em>'.$this->objLanguage->languageText('mod_hotels_storyavailableinfo', 'hotels', 'When should this story be available on the site.').'</em>', 150);
...
$formTable->startRow();
$formTable->addCell($this->objLanguage->languageText('mod_hotels_featuredstory', 'hotels', 'Featured Hotel'));
$formTable->addCell($sticky->show().'<br /><em>'.$this->objLanguage->languageText('mod_hotels_featuredstoryexplanation', 'hotels', 'Featured Stories are highlighted on the Front Page as a sticky or breaking or top story').'</em>');
$formTable->endRow();
...
$label = new label ($this->objLanguage->languageText('mod_hotels_storycategory', 'hotels', 'Hotel Category'), ' input_storycategory');
...
$label = new label ($this->objLanguage->languageText('mod_hotels_storylocation', 'hotels', 'Story Location'), ' input_parentlocation');
...
$label = new label ($this->objLanguage->languageText('mod_hotels_keytags', 'hotels', 'Key Tags'), 'input_keytag1');
...
$label = new label ($this->objLanguage->languageText('mod_hotels_storytags', 'hotels', 'Story Tags').'<br /><em>'.$this->objLanguage->languageText('mod_filemanager_separatewithcommas', 'filemanager', 'Separate with commas').'</em>', 'input_storytags');
...
$topTable->addCell($this->objLanguage->languageText('mod_hotels_storyimage', 'hotels', 'Story Image').':<br /><br />'.$objImageSelect->show());
$topTable->endRow();
...
$storyTable->startRow();
$storyTable->addCell($this->objLanguage->languageText('mod_hotels_storytext', 'hotels', 'Story Text'), 150);
...
$label = new label ($this->objLanguage->languageText('mod_hotels_storysource', 'hotels', 'Story Source'), 'input_storysource');
