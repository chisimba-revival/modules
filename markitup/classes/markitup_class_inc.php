...
class markitup extends ChisimbaObject
{
    ...
    */
    ...
    public function setType($value)
    {
        if (in_array($value, $this->validTypes)) {
            ...
            $msg=$this->objLanguage->languageText('mod_markitup_error_illegalset', 'markitup')
              . ": " . $value;
    ...
    */
    ...
    {
        return $this->getJavascriptFile('jquery.markitup.js','markitup')."\n";
    }
    /**
    *
    ...
    */
    ...
    {
        return $this->getJavascriptFile('sets/' . $this->set .'/set.js','markitup')."\n";
    }
    ...
    */
    private function getMarkItUpCss()
    {
        return "<link rel=\"stylesheet\" type=\"text/css\" href=\""
          . $this->getResourceUri('skins/markitup/style.css', 'markitup')
          . "\" />\n";
    }
    ...
    */
    ...
    {
        $styleSet = "sets/$this->set/style.css";
        return "<link rel=\"stylesheet\" type=\"text/css\" href=\""
          . $this->getResourceUri($styleSet, 'markitup')
          . "\" />\n";
    }
