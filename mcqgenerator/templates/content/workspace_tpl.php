...
if(!$workshopRow){
 ...
 echo '</section><section class="chisimba-form-card"><h2>'.$e($set['title']).'</h2><details><summary>'.$t('saved_source').'</summary><p class="chisimba-preserve-whitespace">'.nl2br($e($set['source_text'])).'</p></details></section>';
 ...
 if(!$questions){
  ...
  $downloads='<section class="chisimba-form-card"><h3>'.$t('downloads').'</h3><p>'.$t('saved_exports').'</p><div class="chisimba-form-actions">';
  ...
  echo $downloads.'<section class="chisimba-form-card">';
  ...
  echo '<section class="chisimba-form-card"><h2>'.$t('review_heading').'</h2><p>'.$t('review_notice').'</p><div class="chisimba-form-field"><label for="set-title">'.$t('set_title').'</label><input id="set-title" name="title" required maxlength="200" value="'.$e($workshopTitle?:$set['title']).'"></div></section>';
  ...
  echo '<section class="chisimba-form-card"><label><input type="checkbox" name="reviewed" value="1"'.(!empty($set['reviewed'])?' checked':'').'> '.$t('review_confirm').'</label><div class="chisimba-form-actions">'.$r->button('save_review','save').'</div></section></form>'.$downloads;
 }
}
