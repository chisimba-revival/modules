...
class helpcontent extends ChisimbaObject
{
    ...
    public function getTopic($topic){
        ...
        if($topic==='exams')return ['title'=>$r->text('help_exams_title'),'summary'=>$r->text('help_exams'),'steps'=>[$r->text('help_workspace'),$r->text('help_exam_select'),$r->text('help_exam_arrange'),$r->text('help_exam_download')],'sections'=>[['heading'=>$r->text('help_course_title'),'body'=>$r->text('help_exam_bank')]]];
