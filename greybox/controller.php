...
/**
* 
* Controller class for Chisimba for the module greybox
*
* @author Derek Keats <derek@dkeats.com>
* @package greybox
*
*/
class greybox extends controller
{
    ...
    */
    ...
    /**
    * 
    * Intialiser for the greybox controller
    * @access public
    * 
    */
    public function init()
    {
        ...
        $this->objGreyboxLoader = & $this->getObject('greyboxloader', 'greybox');
    ...
    /**
     * 
     * The standard dispatch method for the greybox module.
    ...
    */
    ...
    {
        $this->objGreyboxLoader->loadAll();
        $str="<h1>WORKING HERE</h1>";
        $str .= '<a href="http://google.com/" title="Google" rel="gb_page_center[640, 480]">Launch google.com in a 640x480 window</a>';
