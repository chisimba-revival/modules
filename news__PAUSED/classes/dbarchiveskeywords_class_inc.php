...
class dbarchiveskeywords extends dbtable
{

    public function init($tableName = null, $pearDb = null, $errorCallback = 'globalPearErrorHandler')
    {
        parent::init('tbl_archives_keywords');
	...
	{
		$sql = 'SELECT keyword FROM tbl_archives_keywords WHERE storyid=\''.$storyId.'\' ORDER BY keyword';
