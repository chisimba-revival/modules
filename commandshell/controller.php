...
/**
*
* Controller class for Chisimba for the module commandshell
*
* @author Derek Keats
* @package commandshell
*
*/
class commandshell extends controller
{
    ...
    */
    ...
    /**
    *
    * Intialiser for the commandshell controller
    * @access public
    *
    */
    ...
    /**
     *
     * The standard dispatch method for the commandshell module.
    ...
    */
    private function __view()
    {
        if( $this->objUser->isAdmin() ){
            ...
            $str = "<h1>WORKING HERE</h1>You aint admin dude";
        }
    ...
    * be logged in or not. Sets it to require login
    *
    * @return boolean TRUE|FALSE
    *
    */
