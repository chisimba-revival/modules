...
class dbStories extends dbTable
{
    ...
    */
    public function saveStories($mode) {
        //The current user
    ...
    */
    public function deleteStoriesConfirm($key, $keyvalue) {
    ...
    * @param string $keyvalue The group to be deleted
    */
    public function deleteStories($key, $keyvalue) {
    ...
    *
    */
    public function fetchStories($filter = NULL)
    {
