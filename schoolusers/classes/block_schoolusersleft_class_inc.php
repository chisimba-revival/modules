 ...
 *
 */
class block_schoolusersleft extends ChisimbaObject
{
    /**
    ...
    public function init() 
    {
        ...
        $titleLabel = $this->objLanguage->languageText('word_actions', 'system', 'ERROR: word_actions');
