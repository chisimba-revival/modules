 ...
 *
 */
class block_schooluserssuccess extends ChisimbaObject
{
    /**
    ...
    public function init() 
    {
        ...
        $titleLabel = $this->objLanguage->languageText('mod_schoolusers_registrationsuccess', 'schoolusers', 'ERROR: mod_schoolusers_registrationsuccess');
    ...
    {
        $string = '<span class="success">' . $this->objLanguage->languageText('mod_schoolusers_success', 'schoolusers', 'ERROR: mod_schoolusers_success') .'</span>';
