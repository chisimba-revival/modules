 ...
 *
 */
class block_schoolusersshow extends ChisimbaObject
{
    /**
    ...
    public function init() 
    {
        ...
        $titleLabel = $this->objLanguage->languageText('phrase_userdetails', 'system', 'ERROR: phrase_userdetails');
