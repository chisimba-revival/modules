...
if (!class_exists('TCPDF')) {
     ...
     */
    define('PDF_PRODUCER', 'TCPDF 4.0.016 (http://www.tcpdf.org)');
    /**
     * This is a PHP class for generating PDF documents without requiring external extensions.<br>
                                    ...
                                    if ($c == 10) { // 10 = "\n" = new line
                                        ...
                                        if ($l > $wmax) {
                                            ...
                                            if ($sep == -1) {
                                                ...
                                                if (($this->rtl AND ($this->x < ($this->w-$this->rMargin))) OR ((!$this->rtl) AND ($this->x > $this->lMargin))) {
                                                            ...
                                                            public function Polygon($p, $style = "", $line_style = array() , $fill_color = array()) 
                                                            {
                                                                ...
                                                                public function RoundedRect($x, $y, $w, $h, $r, $round_corner = "1111", $style = "", $border_style = array() , $fill_color = array()) 
                                                                {
                                                                    ...
                                                                    protected function utf8Bidi($ta, $forcertl = false) 
                                                                    {
                                                                        ...
                                                                        //$current_level = &$levels[(is_countable($levels) ? count($levels) : 0)-1];
                                                                    ...
                                                                    */
                                                                    public function setVisibility($v) 
                                                                    {
                                                                        ...
                                                                        */
                                                                         ...
                                                                         * @access public
                                                                         */
                                                                        public function LinearGradient($x, $y, $w, $h, $col1 = array() , $col2 = array() , $coords = array(
                                                                            0,
                                                                            0,
                                                                            1,
                                                                            0
                                                                         ...
                                                                         * @access public
                                                                         */
                                                                        public function RadialGradient($x, $y, $w, $h, $col1 = array() , $col2 = array() , $coords = array(
                                                                            0.5,
                                                                            0.5,
                                                                            0.5,
                                                                            0.5,
                                                                         ...
                                                                         * @access public
                                                                         */
                                                                        public function CoonsPatchMesh($x, $y, $w, $h, $col1 = array() , $col2 = array() , $col3 = array() , $col4 = array() , $coords = array(
                                                                            0.00,
                                                                            0.0,
                                                                            0.33,
                                                                            0.00,
                                                                        ...
                                                                        ) , $coords_min = 0, $coords_max = 1) 
                                                                        {
                                                                            ...
                                                                            for ($i = 0; $i < (is_countable($patch_array) ? count($patch_array) : 0); $i++) {
                                                                                    ...
                                                                                    case 'C':
                                                                                        ...
                                                                                        case 'F': {
                                                                                                if ($u > 0) {
                                                                                                    $isU = false;
                                                                                                    $max = min($i+5, $cnt);
                                                                                                    for ($j = $i+1; $j < $max; $j++) $isU = ($isU OR (($lines[$j] == 'U') OR ($lines[$j] == '*U')));
                                                                                                    if ($isU) {
                                                                                                        $this->_out("f*");
                                                                                                    }
                                                                                                } else {
                                                                                            ...
                                                                                            if ($arrcode !== false) {
                                                                                                foreach($arrcode["bcode"] as $k => $v) {
                                                                                                    ...
                                                                                                    if ($v["t"]) {
                                                                                                        ...
                                                                                                        $this->Rect($xpos, $ypos, $bw, ($v["h"]*$barh/$arrcode["maxh"]) , 'DF', array(
                                                                                                            "L" => 0,
                                                                                                            "T" => 0,
                                                                                                            "R" => 0,
                                                                                                            "B" => 0
                                                                                                ...
                                                                                                while ($key <= $maxel) {
                                                                                                    ...
                                                                                                    if (preg_match($tagpattern, $element)) {
                                                                                                        ...
                                                                                                        if ($element[0] == '/') {
                                                                                                            ...
                                                                                                            if (($dom[$key]['value'] [
                                                                                                                0
                                                                                                            ] == "h") AND (intval($dom[$key]['value'] [
                                                                                                                1
                                                                                                            ]) > 0) AND (intval($dom[$key]['value'] [
                                                                                                                1
                                                                                                            ]) < 7)) {
