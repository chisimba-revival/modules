...
/**
*
* Controller class for Chisimba for the module writingtools
*
* @author Derek Keats
* @package writingtools
*
*/
class writingtools extends controller
{
    ...
    */
    public function init()
    {
        ...
        //$this->objDbwritingtools = & $this->getObject('dbwritingtools', 'writingtools');
    ...
    /**
     *
     * The standard dispatch method for the writingtools module.
    ...
    */
    private function __save()
    {
        ...
        $this->objDbwritingtools->save($mode);
