 ...
 * Demo data
 * 
 * Creates demo data for an installation, allowing for test data such as users,
 * etc. as well as enabling the carrying out of a demonstration using fake data.
 * 
 * PHP version 5
 * 
...
/**
* 
* Controller class for Chisimba for the module demodata
*
* @author Derek Keats
* @package demodata
*
...
class demodata extends controller
{
    ...
    */
    ...
    /**
    * 
    * Intialiser for the demodata controller
    * @access public
    * 
    */
    public function init()
    {
        ...
        $this->objDbdemodata = & $this->getObject('dbdemodata', 'demodata');
    ...
    /**
     * 
     * The standard dispatch method for the demodata module.
