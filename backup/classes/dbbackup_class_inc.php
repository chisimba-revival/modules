...
/**
 *
 * Database access for Backup your site
 *
 * Database access for Backup your site. This is a sample database model class
...
*
*/
class dbbackup extends dbtable
{

    /**
    *
    * Intialiser for the backup database connector
    * @access public
    * @return VOID
    *
    */
