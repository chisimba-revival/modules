 ...
 * Filter popup
 * 
 * Popup a window to insert a filter into the content area at the cursor location.
 * 
 * PHP version 5
 * 
...
/**
* 
* Controller class for Chisimba for the module filtergen
*
* @author Derek Keats
* @package filtergen
*
*/
class filtergen extends controller
{
    ...
    */
    ...
    /**
    * 
    * Intialiser for the filtergen controller
    * @access public
    * 
    */
    ...
    /**
     * 
     * The standard dispatch method for the filtergen module.
    ...
    */
    ...
    {
        $str="<h1>All filters</h1>";
        $objFilterXml = $this->getObject('filterxml', 'filtergen');
        $str .= $objFilterXml->getFiltersAsLinks();
    ...
    /**
    * 
    * Method corresponding to the showlink action. It gets the XML
    * description of the particular filter and returns it for display
    * @access private
    * 
    */
    private function __showlinked()
    {
        $objTplHelper = $this->getObject('filtertemplate', 'filtergen');
        $filter=$this->getParam('filter', FALSE);
        $str = $objTplHelper->getXmlRendered($filter);
        $this->setVarByRef('str', $str);
        return 'dump_tpl.php';
    }
    ...
    * 
    */
    private function __showform()
    {
        $filter=$this->getParam('filter', FALSE);
        $objTplHelper = $this->getObject('filtertemplate', 'filtergen');
        $str = $objTplHelper->makeForm($filter);
        $this->setVarByRef('str', $str);
        return 'dump_tpl.php';
    }
    ...
    */
    ...
    {
        $fText = $this->getParam("filter_text", NULL);
        $str = $fText;
        $this->setVarByRef('str', $str);
        return 'dump_tpl.php';
    }
