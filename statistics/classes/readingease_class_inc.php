...
class readingease extends ChisimbaObject {
    ...
    * 
    */
    public function calculateFlesch($str) 
    {
    ...
    * 
    */
    public function calculateReadingGrade($str) 
    {
    ...
    * 
    */
    public function calculateReadingAge($str)
    {
    ...
    * 
    */
    public function averageWordsSentence($str) 
    {
    ...
    * 
    */
    public function averageSyllablesWord($str) 
    {
        $words = explode(' ', $str);
        $syllables="";
