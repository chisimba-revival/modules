...
class text extends ChisimbaObject {
    ...
    */
    public function calc_length($str=NULL)
    {
        if (!$str) {
    ...
    */
    public function count_letters($str=NULL)
    {
        if (!$str) {
            $str=$this->evaluation_string;
        }
    ...
    */
    public function count_words($str=NULL)
    {
        if (!$str) {
            $str=$this->evaluation_string;
        }
    ...
    */
    public function calc_sentence_stats($arr=NULL)
    {
    ...
    */
    public function count_sentences($str=NULL)
    {
        if (!$str) {
            $str=$this->evaluation_string;
        }
    ...
    */
    public function strip_nonalphanumeric($str=NULL)
    {
        if (!$str) {
            $str=$this->evaluation_string;
        }
    ...
    * property
    */
    public function _count_words_noset($str)
    {
