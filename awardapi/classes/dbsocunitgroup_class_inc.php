...
class dbsocunitgroup extends dbTable {
...
function saveRecord($mode)
     {
        ...
        if ($mode == 'edit') {
            $id = $this->getParam('unitGroupId');
            $unitGroup = $this->getRow('id', $id);
            $fields = array('majorGroupId' => $this->getParam('majorGroupId'),
                'subMajorGroupId' => $this->getParam('subMajorGroupId'),
                'minorGroupId' => $this->getParam('minorGroupId'),
                'description' => $this->getParam('description'),
                //'creatorId' => $unitGroup['creatorId'],
              //  'dateCreated' => $unitGroup['dateCreated'],
