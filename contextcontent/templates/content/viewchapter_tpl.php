...
$chapterHeading = $chapterNumber > 0
    ? htmlentities($chapterWord, ENT_QUOTES, 'UTF-8') . ' ' . $chapterNumber . ': ' . $title
    : $title;
...
echo '<div id="context_content" class="contextcontent-chapter-overview"><div class="contextcontent-chapter-back">'.$backLink->show().'</div><section class="contextcontent-chapter-card"><p class="contextcontent-chapter-eyebrow">'.htmlentities($chapterWord,ENT_QUOTES,'UTF-8').'</p><h1 class="contextcontent-chapter-title">'.$chapterHeading.'</h1>';
