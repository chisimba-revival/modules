...
$u = function (array $params = array()) use ($e) {
    return $e(html_entity_decode($this->uri($params, 'contextcontent'), ENT_QUOTES, 'UTF-8'));
};
...
<form method="post" enctype="multipart/form-data" action="<?php echo $u(array('action' => 'previewdocumentimport')); ?>">
...
<?php if (!empty($preview['valid'])): ?><form method="post" action="<?php echo $u(array('action' => 'confirmdocumentimport')); ?>">
...
<a class="button chisimba-button-secondary" href="<?php echo $u(array('action' => 'importdocument')); ?>"><?php echo $e($t('mod_contextcontent_importdocument_cancel')); ?></a>
</div>
