...
$systemText = function ($key, $fallback) {
    return $this->objLanguage->code2Txt($key, 'contextcontent', NULL, $fallback);
};
$heading = new htmlheading();
$heading->type = 1;
$heading->str = $systemText('mod_contextcontent_course_completion_heading', '[-context-] content complete');
echo $heading->show();
?>
<style>
...
<p class="course-completion-intro"><?php echo $systemText('mod_contextcontent_course_completion_intro', 'You have completed the required [-chapter-] assessments.'); ?></p>
<section class="course-completion-panel">
<h2><?php echo $systemText('mod_contextcontent_course_completion_chapters', '[-chapter-] assessments'); ?></h2>
...
<?php else: ?>
<span class="course-completion-status no-gate"><?php echo $systemText('mod_contextcontent_course_completion_no_gate', 'No [-chapter-] quiz required'); ?></span>
<?php endif; ?>
</li>
<?php endforeach; ?>
</ul>
...
<p class="course-completion-placeholder"><?php echo $systemText('mod_contextcontent_course_completion_no_requirements', 'No further requirements have been set for this [-context-].'); ?></p>
</section>
<?php
