 ...
 *
 * @version    $Id: db_contextcontent_comment_class_inc.php 11380 2010-02-11 00:17:11Z qfenama $
...
class db_contextcontent_comment extends dbtable
{
    ...
    {
        parent::init('tbl_contextcontent_page_comment');
