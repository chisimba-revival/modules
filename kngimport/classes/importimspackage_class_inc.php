<?php
/**
 * The class importIMSPackage that manages the import of IMS specification content into Chisimba
 * 
 * PHP version 5
 *
...
class importIMSPackage extends dbTable
{
	...
	*/
	function init()
	{
		...
		// Load Inner classes.
		$this->objIEUtils = $this->newObject('remoteimportexportutils');
	 ...
	 * 
	 * @return TRUE - Successful execution OR Custom error
	 * 
	*/
