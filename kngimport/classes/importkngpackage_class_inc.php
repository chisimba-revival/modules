 ...
 * @author    Jarrett Jordaan, Yasser Buchana
...
class importKNGPackage extends dbTable
{
	...
	*/
	function importKNGcontent($contextcode)
	{
        ...
        /**
        * Importing Users from Kng and adding them to the group
        * @param array $staffList
        * @param string $localCode
        */
        public function importKngUsers($staffList,$localCode)
        {
	...
	*/
	...
	{
//var_dump($values);
		$tree = $this->objContentOrder->getTree($this->contextCode, 'dropdown', $this->parent);
		// Add page.
		...
		$values['bookmark'] = '';
		$values['isbookmark'] = '';
       		$this->pageIds[$values['filename']] = $this->objContentOrder->addPageToContext($titleId, $this->parent, $contextCode, $this->chapterId, $values['bookmark'], $values['isbookmark']);
