...
// end security check
class imstools extends ChisimbaObject 
{
	...
	*/
	...
	function createResource($dom, $lomValues, $eduCommonsValues)
	{
		...
		// Elements Contained in <langstring>:
		// none.
				$langstring = $keyword->appendChild($dom->createElement('langstring', $lomValues['keyword']));
				$langstring->setAttribute('xml:lang', $languageDefault);
			}
		...
		// Elements Contained in <langstring>:
		// none.
				$langstring = $source->appendChild($dom->createElement('langstring', $definedVocab));
				$langstring->setAttribute('xml:lang', $languageDefault);
		// Name : <value> Element in <status>.
		// Description : LOM Defined Vocabularies for status.
		...
		// Name : <langstring> Element in <value>.
		// Description : Entry language.
		// Multiplicity : The <langstring> element can be repeated 1 or more times.
		// Attributes Contained in <langstring>:
		// xml:lang.
		// Elements Contained in <langstring>:
		// none.
				$langstring = $value->appendChild($dom->createElement('langstring', $roleDefault));
				$langstring->setAttribute('xml:lang', $languageDefault);
		...
		// none.
				$location = $technical->appendChild($dom->createElement('location', $lomValues['location']));
			}
		...
		// Elements Contained in <langstring>:
		// none.
				$langstring = $description->appendChild($dom->createElement('langstring', $lomValues['copyrightDate']));
			}
		}
		if($support['relation'])
		{
