...
class workshopexport extends ChisimbaObject
{
    public function disposition(array $set,$format,$answers=false)
    {
        ...
        $name.=($answers?'-answer-key':'-questions').'.'.$format;
