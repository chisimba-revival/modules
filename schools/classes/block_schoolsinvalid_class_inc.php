 ...
 *
 */
class block_schoolsinvalid extends ChisimbaObject
{
    /**
    ...
    public function init() 
    {
        ...
        $titleLabel = $this->objLanguage->languageText('mod_schools_invalidaction', 'schools', 'ERROR: mod_schools_invalidaction');
    ...
    {
        return '<div class="error">' . $this->objLanguage->languageText('mod_schools_actionerror', 'schools', 'ERROR: mod_schools_actionerror') . '</div>';
    }
}
?>