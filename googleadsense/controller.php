...
/**
*
* Controller class for Chisimba for the module googleadsense
*
* @author Derek Keats
* @package googleadsense
*
*/
class googleadsense extends controller
{
    ...
    */
    ...
    /**
    *
    * Intialiser for the googleadsense controller
    * @access public
    *
    */
    public function init()
    {
        ...
        //Get the buildad class to build the ad
        $this->buildAd = $this->getObject('buildad', 'googleadsense');
    ...
    /**
     *
     * The standard dispatch method for the googleadsense module.
    ...
    */
    ...
    {
        $str="<h1>Testing Google AdSense</h1>";
        $this->buildAd->setupByType("banner");
        $str .= $this->buildAd->show();
