...
* @author: Eric Mueller: http://www.themepark.com
* @author: Denis O.Philippov, webmaster@atlant.ru, http://www.atlant.ru
* revised for nextgen by otim samuel, sotim@dicts.mak.ac.ug
*/  

class zipfiles
{   

    public $datasec = array(); // array to store compressed data  
