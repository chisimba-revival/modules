...
foreach (array('essay-default-rubric-v2','Response to the task and argument','Knowledge and accuracy','Analysis, synthesis and judgement','Evidence and support','Organisation and coherence','Academic expression','Depth and independent engagement') as $expected) {
