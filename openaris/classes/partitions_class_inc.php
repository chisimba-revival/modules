...
// end security check
 ...
 class partitions extends dbtable{
 /**
	...
	public function init($tableName = null, $pearDb = null, $errorCallback = 'globalPearErrorHandler') {
		try {
			parent::init('tbl_ahis_partitions');
	...
	public function addPartition($partitioncode,$partitionlevel,$partitionname,$parentpartition,$startdate,$enddate)
	{
			...
			'partitionlevelid' => $partitionlevel,
			'partitioncode' => stripslashes($partitioncode),
			'partitionname' => stripslashes($partitionname),
	...
	public function editPartition($id,$partitioncode,$partitionlevel,$partitionname,$parentpartition,$startdate,$enddate)
	{
