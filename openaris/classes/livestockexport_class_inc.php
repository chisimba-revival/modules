 ...
 */
 ...
 class livestockexport extends dbtable{
 /**
	...
	public function init($tableName = null, $pearDb = null, $errorCallback = 'globalPearErrorHandler') {
		try {
			parent::init('tbl_ahis_livestockexport');
		}
	...
	public function addLivestockexportData($district,$entrypoint,$destination,$classification,$origin,$eggs,$milk,$cheese,$poultry,$beef,$count)
    {
