<?php
/**
 * ahis infection sources Class
 *
 * infection sources class
 * 
 * PHP version 5
 * 
 ...
 */
 ...
 class infectionsources extends dbtable{
 /**
	...
	public function init($tableName = null, $pearDb = null, $errorCallback = 'globalPearErrorHandler') {
		try {
			parent::init('tbl_ahis_infectionsource');
		}
	...
	public function addInfectionSourceData($possible_source,$abbreviation,$description,$dateStartPicker,$dateEndPicker,$dateCreatedPicker,$createdby,$dateModifiedPicker,$modifiedby)
    {
		
			$sql = $this->insert(array(
			'possiblesource' => stripslashes($possible_source),
