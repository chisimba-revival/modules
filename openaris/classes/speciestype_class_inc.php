...
class speciestype extends dbtable {
	...
	public function init($tableName = null, $pearDb = null, $errorCallback = 'globalPearErrorHandler') {
		try {
			parent::init('tbl_ahis_speciestypes');
	...
	public function addSpeciesType($speciestype,$abbreviation,$description,$startdate,$enddate)
	{
	...
	public function editSpeciesType($id,$speciestype,$abbreviation,$description,$startdate,$enddate)
	{
