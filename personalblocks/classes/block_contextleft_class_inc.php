...
*
*/
class block_contextleft extends ChisimbaObject
{
    /**
    ...
    */
    public function init()
    {
        ...
        $this->title = $this->objLanguage->code2txt('mod_personalblocks_contextleft', 'personalblocks');
    ...
    */
    private function getWidget()
    {
        ...
        return $objPbrender->renderLeft(TRUE, "context");
    }
}
?>