...
/**
 *
 * Block for viewing group info
 *
 * A block for viewing group info that can be rendered using a JSON
 * template.
 *
 ...
 *
 */
class block_viewgroup extends ChisimbaObject
{
    /**
     *
    ...
    public function show() 
    {
        ...
        $groupId = $this->configData;
        
        return $groupManager->buildViewGroupDetails($groupId);
    }
}
?>