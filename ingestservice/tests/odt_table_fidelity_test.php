...
$zip->addFromString('content.xml', '<?xml version="1.0"?><office:document-content '
    ...
    . 'xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" '
    . 'xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:xlink="http://www.w3.org/1999/xlink">'
    . '<office:automatic-styles><style:style style:name="Table_Heading" style:display-name="Table Heading" style:family="paragraph"/></office:automatic-styles>'
    . '<office:body><office:text><table:table><table:table-row>'
    . '<table:table-cell table:number-columns-spanned="2"><text:p text:style-name="Table_Heading">Merged heading</text:p></table:table-cell>'
