...
/**
 *
 * Database access for simpletalk durations
 *
 * Database access for durations for dropdowns when selecting a conference talk. 
...
*
*/
class dbdurations extends dbtable
{
    ...
    */
    public function init($tableName = null, $pearDb = null, $errorCallback = 'globalPearErrorHandler')
    {
        ...
        parent::init('tbl_simpletalk_durations');
    }
