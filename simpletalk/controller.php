 ...
 * 
 * A simplified version of an interface to submit a conference talk and have it accepted or rejected for a conference.
 * 
 * PHP version 5
 * 
...
/**
* 
* Controller class for Chisimba for the module simpletalk
*
* @author Derek Keats
* @package simpletalk
*
*/
class simpletalk extends controller
{
    ...
    */
    ...
    /**
    * 
    * Intialiser for the simpletalk controller
    * @access public
    * 
    */
    public function init()
    {
        ...
        $this->objDbsimpletalk = & $this->getObject('dbsimpletalk', 'simpletalk');
        $this->appendArrayVar('headerParams',
          $this->getJavaScriptFile('simpletalk.js',
          'simpletalk'));
    ...
    /**
     * 
     * The standard dispatch method for the simpletalk module.
    ...
    */
    private function __save()
    {
        ...
        $this->objDbsimpletalk->save($mode);
